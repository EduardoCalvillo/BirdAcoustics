...
for(i in 1:qty){
    ...
    x <- c(runif(paquete,0,50),
           runif(paquete,50,100),runif(paquete,100,150),runif(paquete,150,200)) #Numeros aleatorios representando ACIs pero con limites marcados por nivel de prescencia
